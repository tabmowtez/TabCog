...
__author__ = "tabmowtez"

log = logging.getLogger("red.tabmowtez.WorldBossDM")


class WorldBossDM(commands.Cog):
    """Send a direct message to all members of the specified Role."""

    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)

    @commands.command(aliases=["wbdm"])
    @commands.guild_only()
    @checks.admin_or_permissions(manage_guild=True)
    async def WorldBossDM(self, ctx: commands.Context, role: discord.Role, *, message: str) -> None:
